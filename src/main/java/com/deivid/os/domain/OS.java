...
public class OS {
	...
	@ManyToOne //São muitas OS para UM técnico 
	@JoinColumn (name="tecnico_id") // Criar a coluna do técnico na base de dados
	private Tecnico tecnico;
	
	
	
	@ManyToOne //São muitas OS para UM técnico 
	@JoinColumn (name="cliente_id") // Criar a coluna do técnico na base de dados
